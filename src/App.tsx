...
function App() {
    ...
    script.onload = () => {
      ...
      messenger.addEventListener("df-response-received", (event: Event) => {
        ...
        try {
          ...
          const userIntent =
            customEvent.detail.response.queryResult?.intent?.displayName;
  ...
  return (
    ...
    >
      ...
      <div className="d-flex justify-content-center">
        <div className="btn-group fixed-top w-25">
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              Click and drag to highlight any word or phrase in the chat box for
